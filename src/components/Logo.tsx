    ...
    return (
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
            <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M10 50 L30 20 L60 20" stroke="rgba(255, 255, 255, 0.2)" strokeWidth="8" strokeLinecap="round" />
                <circle cx="75" cy="45" r="15" stroke="url(#grad1)" strokeWidth="6" />
            </svg>
            {showText && (
                <div style={{ fontWeight: 800, fontSize: `${size * 0.6}px`, lineHeight: 1, letterSpacing: '-1px' }}>
                    <span style={{ color: 'var(--primary)' }}>SPORT</span>
